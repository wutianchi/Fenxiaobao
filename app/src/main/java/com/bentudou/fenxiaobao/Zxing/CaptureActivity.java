package com.bentudou.fenxiaobao.Zxing;
...
import com.bentudou.fenxiaobao.Zxing.camera.CameraManager;
import com.bentudou.fenxiaobao.Zxing.decoding.CaptureActivityHandler;
import com.bentudou.fenxiaobao.Zxing.decoding.InactivityTimer;
import com.bentudou.fenxiaobao.Zxing.decoding.RGBLuminanceSource;
import com.bentudou.fenxiaobao.Zxing.decoding.Utils;
import com.bentudou.fenxiaobao.Zxing.view.ViewfinderView;
				...
				new Thread(new Runnable() {
					...
					public void run() {
						...
						if (result == null) {
							...
							startActivity(new Intent(CaptureActivity.this, ShareGoodsActivity.class).putExtra("result",recode));
